...
class TaxRatesApi
{
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\Model\TaxRate, HTTP status code, HTTP response headers (array of strings)
     */
    public function taxRateGETRequestTaxIDGetWithHttpInfo($accept, $tax_id, $jiwa_stateful = null)
    {
        $returnType = '\Jiwa\Model\TaxRate';
     ...
     * @param  \Jiwa\Model\TaxRatePATCHRequest $body body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\Model\TaxRate
     ...
     * @param  \Jiwa\Model\TaxRatePATCHRequest $body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\Model\TaxRate, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  bool $is_enabled is_enabled (optional)
     * @param  string $ledger_account ledger_account (optional)
     * @param  \Jiwa\Model\TaxRatePOSTRequest $body body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\Model\TaxRate
     ...
     * @param  bool $is_enabled (optional)
     * @param  string $ledger_account (optional)
     * @param  \Jiwa\Model\TaxRatePOSTRequest $body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\Model\TaxRate, HTTP status code, HTTP response headers (array of strings)
