...
class LogsApi
{
     ...
     * @return \Jiwa\Model\QueryResponseRequestLogEntry_
     */
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\Model\QueryResponseRequestLogEntry_, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Jiwa\Model\QueryResponseRequestLogEntry_';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Jiwa\Model\QueryResponseRequestLogEntry_',
