...
class ReportsApi
{
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\Model\IHttpResult, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Jiwa\Model\IHttpResult';
