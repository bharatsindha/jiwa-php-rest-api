...
class WarehouseTransfersInApi
{
     ...
     * @param  bool $jiwa_stateful Stateful indicator (optional)
     * @param  \Jiwa\JiwaModel\WarehouseTransferInACTIVATERequest $body body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\JiwaModel\WarehouseTransferIn
     */
     ...
     * @param  bool $jiwa_stateful Stateful indicator (optional)
     * @param  \Jiwa\JiwaModel\WarehouseTransferInACTIVATERequest $body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\WarehouseTransferIn, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Jiwa\JiwaModel\WarehouseTransferIn';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Jiwa\JiwaModel\WarehouseTransferIn',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\WarehouseTransferInLine, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Jiwa\JiwaModel\WarehouseTransferInLine';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Jiwa\JiwaModel\WarehouseTransferInLine',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \Jiwa\JiwaModel\WarehouseTransferInLinePATCHRequest $body body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\JiwaModel\WarehouseTransferInLine
     ...
     * @param  \Jiwa\JiwaModel\WarehouseTransferInLinePATCHRequest $body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\WarehouseTransferInLine, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \Jiwa\JiwaModel\WarehouseTransferInPATCHRequest $body body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\JiwaModel\WarehouseTransferIn
     ...
     * @param  \Jiwa\JiwaModel\WarehouseTransferInPATCHRequest $body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\WarehouseTransferIn, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  string $receive_ins receive_ins (optional)
     * @param  string $lines lines (optional)
     * @param  \Jiwa\JiwaModel\WarehouseTransferInPOSTRequest $body body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\JiwaModel\WarehouseTransferIn
     ...
     * @param  string $receive_ins (optional)
     * @param  string $lines (optional)
     * @param  \Jiwa\JiwaModel\WarehouseTransferInPOSTRequest $body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\WarehouseTransferIn, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\WarehouseTransferInReceiveIn[], HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Jiwa\JiwaModel\WarehouseTransferInReceiveIn[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Jiwa\JiwaModel\WarehouseTransferInReceiveIn[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
