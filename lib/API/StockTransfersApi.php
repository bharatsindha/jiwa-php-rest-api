...
class StockTransfersApi
{
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\JiwaModel\StockTransfer
     */
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\StockTransfer, HTTP status code, HTTP response headers (array of strings)
     */
    public function stockTransferGETRequestTransferIDGetWithHttpInfo($accept, $transfer_id, $jiwa_stateful = null)
    {
        $returnType = '\Jiwa\JiwaModel\StockTransfer';
     ...
     * @param  \Jiwa\JiwaModel\StockTransferPOSTRequest $body body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\JiwaModel\StockTransfer
     ...
     * @param  \Jiwa\JiwaModel\StockTransferPOSTRequest $body (optional)
     *
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\StockTransfer, HTTP status code, HTTP response headers (array of strings)
