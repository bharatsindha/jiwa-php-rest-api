...
class AuthApi
{
     ...
     * @return \Jiwa\JiwaModel\AuthenticateResponse
     */
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\AuthenticateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Jiwa\JiwaModel\AuthenticateResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Jiwa\JiwaModel\AuthenticateResponse',
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Jiwa\JiwaModel\LogoutGetResponse
     */
     ...
     * @throws \Jiwa\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Jiwa\JiwaModel\LogoutGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function logoutGetRequestlogoutGetWithHttpInfo($accept, $jiwa_stateful = null)
    {
        $returnType = '\Jiwa\JiwaModel\LogoutGetResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Jiwa\JiwaModel\LogoutGetResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
